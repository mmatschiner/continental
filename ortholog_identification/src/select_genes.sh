...
rm -f ../res/trees/nuclear/strict/*
mkdir -p ../res/trees/nuclear/permissive
rm -f ../res/trees/nuclear/permissive/*
mkdir -p ../res/alignments/nuclear/strict
rm -f ../res/alignments/nuclear/strict/*
mkdir -p ../res/alignments/nuclear/permissive
rm -f ../res/alignments/nuclear/permissive/*

# Set strict and permissive thresholds.
min_min_ess_strict=200
min_min_ess_permissive=100
max_mut_rate_strict=0.0014
max_mut_rate_permissive=0.0016
max_rate_var_strict=0.6
max_rate_var_permissive=0.7
